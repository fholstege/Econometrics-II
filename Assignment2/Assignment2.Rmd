...
Fixed-effects model should be preferred in our settings, as it is highly likely that unobserved individual effects would be correleted with our regressors, i.e. $E[\eta_i|X_{i1}, . . . , X_{iT} ] \neq 0$. This is due to the fact that our model has endogenity issues,thus, fixed-effects model is the preferred choice and gives us the best consistent estimates.
