...
\begin{align*}
\beta_{wald} =  \frac{0.4 - 0.2}{0.7 - 0.4} = \frac{0.2}{0.3} = \frac{2}{3}
\end{align*}

This implies that if one receives a prison sentence, one is \frac{2}{3} more likely to be arrested in the subsequent 3 years. This effect holds for all compliers, e.g. those who underwent the treatment. In this case, if the prison sentence is strongly enforced (e.g. nobody is able to escape), then presumably the effect holds for the whole population, since all are complying. 
